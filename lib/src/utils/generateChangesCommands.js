        ...
        switch (dif.kind) {
            case 'N':
                if (dif.path.length === 1) {
                    ...
                    upCommands.push({
                        order: 0,
                        cmds: [genTableCommands_1.genCreateTableCommand(model.name, model.columns, model.options)],
                    });
                    upCommands.push({
                        order: 2,
            ...
            case 'D':
                if (dif.path.length === 1) {
                    ...
                    downCommands.push({
                        order: 0,
                        cmds: [genTableCommands_1.genCreateTableCommand(dif.path[0], dif.lhs.columns, dif.lhs.options)],
                    });
                    break;
                }
                if (dif.path.length > 1 && dif.path[1] === 'indexes') {
